...
public class EditNotesTest {
    ...
    public void setUp() throws InterruptedException {
        ...
        Thread.sleep(15000);  // Adjust the time as needed
    ...
    @Test
    public void testCEditNotesFunctionality() throws InterruptedException {
        ...
        List<WebElement> fullNotesContent = fullNotesSection.findElements(By.className("col-9"));
        assertEquals("Should only have 2 notes", 2, fullNotesContent.size());
        assertEquals("Test 3", fullNotesContent.get(0).getText().trim());
